...
if __name__ == '__main__':
	...
	test_dict = {'accuracy': [test_accuracy,test_accuracy], 'recall':[test_recall,test_recall], 'precision':[test_precision,test_precision], 'training_time': [test_trainingTime,train_trainingTime]}
